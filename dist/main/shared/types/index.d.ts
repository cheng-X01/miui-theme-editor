...
export declare const IPC_CHANNELS: {
    /** 打开文件对话框 */
    readonly OPEN_FILE: "dialog:open-file";
    /** 保存文件对话框 */
    readonly SAVE_FILE: "dialog:save-file";
    /** 读取文件内容 */
    readonly READ_FILE: "fs:read-file";
    /** 写入文件内容 */
    readonly WRITE_FILE: "fs:write-file";
    /** 解析 MTZ 主题包 */
    readonly PARSE_MTZ: "mtz:parse";
    /** 打包 MTZ 主题包 */
    readonly PACK_MTZ: "mtz:pack";
    /** 列出已连接设备 */
    readonly LIST_DEVICES: "device:list";
    /** 获取设备详细信息 */
    readonly GET_DEVICE_INFO: "device:info";
    /** 推送主题到设备 */
    readonly PUSH_THEME: "device:push";
    /** 应用主题到设备 */
    readonly APPLY_THEME: "device:apply";
    /** 截屏 */
    readonly SCREENSHOT: "device:screenshot";
    /** WiFi 连接设备 */
    readonly CONNECT_WIFI: "device:connect-wifi";
    /** 监控设备连接状态 */
    readonly MONITOR_DEVICES: "device:monitor";
    /** AI 生成文本 */
    readonly AI_GENERATE_TEXT: "ai:generate-text";
    /** AI 流式生成文本 */
    readonly AI_STREAM_TEXT: "ai:stream-text";
};
