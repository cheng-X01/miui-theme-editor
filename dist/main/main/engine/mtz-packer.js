...
<MIUI_Theme version="2">
  ...
  ${desc.tags && desc.tags.length > 0 ? `<tags>${desc.tags.map((t) => this.escapeXml(t)).join(',')}</tags>` : ''}
     ...
     * 添加图标资源到 ZIP 包
     */
    async addIcons(zip, icons, compress, compressionLevel, files) {
     ...
     * 添加壁纸资源到 ZIP 包
     */
    async addWallpapers(zip, wallpapers, compress, compressionLevel, files) {
     ...
     * 添加字体资源到 ZIP 包
     */
    async addFonts(zip, fonts, compress, compressionLevel, files) {
     ...
     * 添加声音资源到 ZIP 包
     */
    async addSounds(zip, sounds, compress, compressionLevel, files) {
     ...
     * 添加锁屏资源到 ZIP 包
     */
    async addLockscreens(zip, lockscreens, compress, compressionLevel, files) {
